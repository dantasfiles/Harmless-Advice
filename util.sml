...
fun stringtoVector s =
	...
	val ints = map Char.ord chars
	val word8s = map Word8.fromInt ints
	val vector = Word8Vector.fromList word8s
    in 
	vector
    end
...
fun vectortoString v =
    let
	val words = Word8Vector.foldr (fn (e, l) => e::l) nil v
	val ints = map Word8.toInt words
	val chars = map Char.chr ints
